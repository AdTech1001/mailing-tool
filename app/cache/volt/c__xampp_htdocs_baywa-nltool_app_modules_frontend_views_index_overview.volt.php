...
<div class="container">
	...
	<div class="desktop">
		...
		<div class="module_el">
			<h2><?php echo $this->tag->linkTo(array($language . '/campaigns/create/', '<span class="glyphicon glyphicon-envelope"></span> ' . nltool\Modules\Modules\Frontend\Controllers\ControllerBase::translate('campaign'), 'title' => nltool\Modules\Modules\Frontend\Controllers\ControllerBase::translate('campaign'))); ?>
			</h2>
			<ul>
		...
		<div class="module_el">
			...
			<li><?php echo $this->tag->linkTo(array($language . '/contenobjectst/index/', '<span class="glyphicon glyphicon-pencil"></span> ' . nltool\Modules\Modules\Frontend\Controllers\ControllerBase::translate('contentobjectsRetrieve'), 'title' => nltool\Modules\Modules\Frontend\Controllers\ControllerBase::translate('contentobjectsRetrieve'))); ?></li>
